...
class UsuariosController extends Controller
{
    ...
    public function store(Request $request) //funcao salvar dados de novos usuarios
    {
        ...
        return redirect('usuarios')->with('success', 'Usuario cadastrado com sucesso.'); //retorno da mensagem de sucesso
    }
    ...
    public function update(Request $request, $id) //funcao para atualizar edicoes no banco
    {
        ...
        return redirect('usuarios')->with('success', 'Usuario alterado com sucesso.'); //retorna mensagem de sucesso na alteração dos dados
    }
    ...
    public function destroy($id) //funcao para executar o delete no banco
    {
        ...
        return redirect('usuarios')->with('success', 'Usuario excluído com sucesso.'); //retorna mensagem de sucesso ao deletar usuario
    }
}
